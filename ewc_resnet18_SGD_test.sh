...
while [ "$(bc <<< "$lamb <= $lamb_limit")" == "1"  ]; do
    CUDA_VISIBLE_DEVICES=3 python main.py --trainer ewc --model resnet18 --optimizer SGD --dataset CIFAR100_for_Resnet --nepochs 100 --lr 0.1 --lamb $lamb --batch-size 256 --seed 0 --tasknum 20 --schedule 40 80
