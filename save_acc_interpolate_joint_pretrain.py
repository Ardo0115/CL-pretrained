...
def main():
    ...
    for task_t, _ in task_info:
        ...
        task_model.load_state_dict(torch.load('./trained_model/_CIFAR100_for_Resnet_from_pretrained_resnet18_Adam_0_lamb_0_lr_0.001_batch_256_epoch_60_task_{}.pt'.format(task_t)))
    ...
    for t, ncla in task_info:
        ...
        model1.load_state_dict(torch.load('./trained_model/_CIFAR100_for_Resnet_joint_Adam_0_lamb_lr_0.001_batch_256_epoch_60_task_0.pt'))
        for u in range(t+1):
        ...
        #     np.savetxt('joint_Adam_interpolate_from_model_{}.txt'.format(task_t), acc_t, '%.4f')
