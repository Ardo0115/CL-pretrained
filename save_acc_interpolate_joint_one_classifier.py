...
def main():
    ...
    for task_t, _ in [(0,5)]:
        ...
        task_model.load_state_dict(torch.load('./trained_model/_CIFAR100_for_Resnet_from_pretrained_resnet18_SGD_0_lamb_0_lr_0.1_batch_256_epoch_100_tasknum_10_task_{}.pt'.format(task_t)))
    ...
    for t, ncla in task_info:
        ...
        model1.load_state_dict(torch.load('./trained_model/_CIFAR100_for_Resnet_from_pretrained_resnet18_SGD_0_lamb_0_lr_0.1_batch_256_epoch_100_tasknum_1_task_0.pt'))
        ...
        for task_t, acc_loss in enumerate(zip(acc, lss)):
            ...
            np.savetxt('./one_classifier_interpolate/joint_SGD_interpolate_num_trached_from_model_{}.txt'.format(task_t), acc_t, '%.4f')
