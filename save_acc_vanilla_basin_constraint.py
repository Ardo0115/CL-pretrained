    ...
    for t, ncla in task_info:
        ...
        for u in range(t+1):
            ...
            if t==0:
                ...
                print(f"Distance from model0 to model_{t}' : {compute_distance(model1, model2)}, Radius : {compute_distance(model1, model2)/2.0}")

            else:
                model1 = middle_model
                model2 = task_models[t]
                print(f"Distance from center to model_{t} : {compute_distance(model1, model2)}")
            break
