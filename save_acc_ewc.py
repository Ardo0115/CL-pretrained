...
def main():
    ...
    for task_t, _ in task_info:
        ...
        task_model.load_state_dict(torch.load('./trained_model/_CIFAR100_for_Resnet_ewc_from_random_Adam_0_lamb_10000000.0_lr_0.001_batch_256_epoch_60_task_{}.pt'.format(task_t)))
    ...
    for t, ncla in task_info:
        ...
        #     np.savetxt('ewc_from_random_Adam_interpolate_from_model_{}.txt'.format(task_t), acc_t, '%.4f')
