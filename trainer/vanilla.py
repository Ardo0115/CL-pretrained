...
class Trainer(trainer.GenericTrainer):
    ...
    def train(self, train_loader, test_loader, t, device = None):
        ...
        for epoch in range(self.args.nepochs):
            ...
            print()
        log_name = '_{}_{}_{}_{}_lr_{}_batch_{}_epoch_{}_tasknum_{}'.format(self.args.dataset,self.args.trainer, self.args.optimizer, self.args.seed,
                                                                           self.args.lr, self.args.batch_size, self.args.nepochs, self.args.tasknum)
