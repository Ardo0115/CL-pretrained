...
class Trainer(trainer.GenericTrainer):
    ...
    def train(self, train_loader, test_loader, t, device = None):
        ...
        log_name = '{}_{}_{}_{}_lamb_{}_lr_{}_batch_{}_epoch_{}'.format('', 'CIFAR10', 'film_resnet18_Adam',0,
                                                                        0.0, 0.001, 256, 60)
        self.device = device
        lr = self.args.lr
        ...
        if t == 0: 
            tmp_model = networks.ModelFactory.get_model('CIFAR10', 'film_resnet18_Adam', [(0,10)])
    ...
    def criterion(self,output,targets):
        ...
        if self.t > 0:
            ...
            loss_reg += torch.sum(self.fisher * param_diff.pow(2))
    ...
    def compute_film_fisher(self):
        ...
        for samples in tqdm(self.fisher_iterator):
            ...
            fisher += batch_size**2 * film_params_grad.pow(2)
